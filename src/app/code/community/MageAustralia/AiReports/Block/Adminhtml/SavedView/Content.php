...
class MageAustralia_AiReports_Block_Adminhtml_SavedView_Content extends Mage_Adminhtml_Block_Template
{
    ...
    public function getRunLogUrl(): string
    {
        return $this->getUrl('adminhtml/aireports/runLog');
    }
}
